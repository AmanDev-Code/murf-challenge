...
PURPOSE_TEMPLATES = {
    ...
    "escalation_callback": {
        "en": (
            "You called {user_name} to inform them about the resolution of their "
            "escalation ticket {reference_id}. The issue type was: {issue_type}. "
            "Resolution: {resolution}. "
            "Explain the resolution clearly and concisely. Ask if they have any questions. "
            "If they are satisfied, wish them well. If not, offer to create a new ticket."
        ),
        "hi": (
            "{user_name} को उनकी ticket {reference_id} के resolution के बारे में बताने call किया। "
            "Issue type: {issue_type}. Resolution: {resolution}. "
            "Resolution clearly explain करें और पूछें कि और कोई सवाल है। "
            "अगर satisfied हैं तो धन्यवाद बोलें। नहीं तो नया ticket offer करें।"
        ),
        "opening_en": "We have an update on your ticket {reference_id}. Your issue has been resolved and I wanted to share the details with you.",
        "opening_hi": "आपकी ticket {reference_id} पे update है। आपका issue resolve हो गया है, details बताना चाहती थी।",
    },
}
