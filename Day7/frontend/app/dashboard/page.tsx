...
import { AlertCircle, Clock, CheckCircle2, AlertTriangle, Shield, RefreshCw } from 'lucide-react';
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-6 flex flex-wrap items-center gap-3">
          <FilterSelect
            ...
            labels={['All Status', 'Open', 'In Progress', 'Awaiting Callback', 'Resolved', 'Closed']}
          />
          <FilterSelect
        ...
        {loading ? (
          ...
          <div className="flex h-64 flex-col items-center justify-center rounded-xl border border-white/[0.06] bg-white/[0.02]">
                ...
                {escalations.map((esc) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3">
                      <span className={`rounded-full border px-2 py-0.5 text-xs ${typeBadge[esc.type] || ''}`}>
                        {esc.type}
                      </span>
                    </td>
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-2">
                        <span className={`h-2 w-2 rounded-full ${urgencyColor[esc.urgency]}`} />
                    ...
                    <td className="px-4 py-3">
                      <span className={`rounded-full border px-2 py-0.5 text-xs ${statusPill[esc.status] || ''}`}>
